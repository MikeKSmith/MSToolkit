---
layout: page
title: MSToolkit code for assessing dose-response using Emax function
description: R code for generating data from an Emax dose-response model and
fit the simulated data with a similar model.
---
...
## Calls emaxfit.R - helper functions for fitting an emax model
##  or linear model if the emax fit does not converge
